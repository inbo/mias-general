---
title: "Plan of action - table examples for freshwater animals"
author: "Janne Adolf"
date: "`r Sys.Date()`"
output: 
  html_document:
...
- Step 2: determine surveillance scope(s) dependent on invasion stadium
- e.g., detection if absent, inventory and distribution and abundance if limited established
- Step 3: consider (‘absolute’) need and feasibility
- suitability / scope of method (presence vs. (relative) numbers)
- status in conservation area
- status of surveillance area (known vs. unknown)
- Step 4: Obtain base table


```{r base-table-display}
...
- Step 5: Filter base table further considering (‘relative’) need and feasibility
- urgency >= 3
