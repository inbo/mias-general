...
### Score patterns "unknown" vs. rest per question
...
### Ranking according to mean response scores
...
#
ggraph::ggraph(graph = res_plot_tmp, layout = 'linear', circular = FALSE) +
...
plot_meth_patt + 
  ggplot2::geom_rect(
    data = data_bg,
    ggplot2::aes(xmin = x_cat_min, xmax = x_cat_max, ymin = y_cat_min, ymax = y_cat_max),
    alpha = 0,
    fill = "green",
    alpha = .2
  ) +
...
# habitat as facet rows 

# plants vs. animals

# in function of invasion stadium
