...
var formtitlelist = ['Myriophyllum heterophyllum Michx.','Nasua nasua (Linnaeus, 1766)','Nyctereutes procyonoides (Gray, 1834)','Obama nungara Carbayo, Alvarez-Presas, Jones & Riutort, 2016','Ondatra zibethicus (Linnaeus, 1766)','Oxyura jamaicensis (J.F.Gmelin, 1789)','Pachycondyla chinensis (Emery, 1895)','Pacifastacus leniusculus (Dana, 1852)','Parthenium hysterophorus L.','Perccottus glenii Dybowski, 1877','Persicaria perfoliata (L.) H.Gross','Pistia stratiotes L.','Platydemus manokwari Beauchamp, 1962','Plotosus lineatus (Thunberg, 1787)','Pontederia crassipes Mart.','Procambarus clarkii (Girard, 1852)','Procambarus virginalis Lyko, 2017','Procyon lotor (Linnaeus, 1758)','Prosopis juliflora (Sw.) DC.','Pseudorasbora parva (Temminck & Schlegel, 1846)'];
var specieslist = ['Myriophyllum heterophyllum Michx.','Nasua nasua (Linnaeus, 1766)','Nyctereutes procyonoides (Gray, 1834)','Obama nungara Carbayo, Alvarez-Presas, Jones & Riutort, 2016','Ondatra zibethicus (Linnaeus, 1766)','Oxyura jamaicensis (J.F.Gmelin, 1789)','Pachycondyla chinensis (Emery, 1895)','Pacifastacus leniusculus (Dana, 1852)','Parthenium hysterophorus L.','Perccottus glenii Dybowski, 1877','Persicaria perfoliata (L.) H.Gross','Pistia stratiotes L.','Platydemus manokwari Beauchamp, 1962','Plotosus lineatus (Thunberg, 1787)','Pontederia crassipes Mart.','Procambarus clarkii (Girard, 1852)','Procambarus virginalis Lyko, 2017','Procyon lotor (Linnaeus, 1758)','Prosopis juliflora (Sw.) DC.','Pseudorasbora parva (Temminck & Schlegel, 1846)'];
var mapidlist = ['14jJjpYo2M3h7CSCKB7uE2Szg18BYbPMi','14hGO6WAhtaDO3uKVxELuVwHL-TmaDAdh','14aTgfASiWcm1QCZdjy1jfhJze6fLZr9B','14QACJ-GWSZdSu7fRV35VQ3UJLgCoGvOd','14NPgRFXfZM6KGU7uaQIIbjxjXV9qR687','14KRrIjK0wBCr9Uit3rGVlEP337P04dgI','14Ib236wlBF4GuO7B7ZhaVo5gY0bZ7QNR','14G_zZ-cMAY1O5lfpzuzUEOtPmq685Fru','15O0RwotWnf6zLo34YCmAd2FSPhAN3KUR','15MSBqe5QhvFvEcfvmPh2-uwrM6OduncL','15MI5YNsRUQjsAkzsVZXUzPfljHVbr9mK','15JTjNnKtgiNfIBnJAenETnENxZpCJP6H','158IGkpyS98tIUrWYVwfEaJjlhBQdAJ8N','14xk_gi1UuheNhPSoB4Xd0qqEsJww-P2G','14tvjis_uNexEA1nygSiBVhyV292owtA1','14sPRqvPbb7duR_VqQjysEk1WgZZClP4f','15ihXv3iqe9XM9HcWNry2LZUBRg74XJjN','15h6cnKsHUybNulDEovSCH3rElLDNpi5x','15gHQoDyoTiSEkf4KOModoY-sHu09zJtR','15dMemB2UvH5EatEo2vpJ0pCx4Ir3yegE'];
