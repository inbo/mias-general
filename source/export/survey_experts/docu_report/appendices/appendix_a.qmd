...
All scientific names are the currently accepted scientific names according to the Global Biodiversity Information Facility (GBIF; ref).
...
The question "Is the distribution of the species across Flanders sufficiently known?" was complemented by species-specific distribution maps based on recent data from GBIF [@gbif_the_global_biodiversity_information_facility_what_2025] (ref GBIF; ref data).
...
![Example occurrence map based on GBIF data](../../../../../media/gbif_occcubes/plots_ggspatial/muntiacus_reevesi_(ogilby,_1839).png){width=100%}
