...
In Stage 2 of the prioritisation process, we further filter the withheld relevant species-scope combinations by excluding low priority instances. 
...
For a species-scope combination withheld after the entire prioritisation process, the corresponding table cell holds the monitoring methods reported for this species.
